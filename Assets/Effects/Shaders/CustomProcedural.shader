...
Shader "Skybox/CustonmProcedural" {
	Properties{
		...
		SubShader{
			...
			Pass {
				...
				static const float3 kDefaultScatteringWavelength = float3(.65, .47, .475);
				static const float3 kVariableRangeForScatteringWavelength = float3(.05, .05, .05);
