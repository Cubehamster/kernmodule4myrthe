...
public class FPSadjusted : MonoBehaviour
{
...
public class BETA_SETTINGS{
    ...
    private void Update()
    {
        ...
        if (enableCameraMovement)
        {
            ...
            transform.localRotation = Quaternion.Euler(0, followAngles.y + originalRotation.y, followAngles.z + originalRotation.z);
        }
    ...
    public void portalRotation(Vector3 rotation)
    {
